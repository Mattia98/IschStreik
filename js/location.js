(() => {
  "use strict";
    ...
    const successFunction = (position) => {
		...
		//let response = JSON.parse(httpGet("https://maps.googleapis.com/maps/api/geocode/json?latlng=41.025389,16.554028&key=AIzaSyADHXzFMh1Hh01uVyRzuPvav-kmzYltFwo"));
